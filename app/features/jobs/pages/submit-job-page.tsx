...
import { JOB_LOCATIONS, JOB_SALARIES, JOB_TYPES } from "../constants";
import SelectPair from "~/common/components/select-pair";
import { Button } from "~/common/components/ui/button";

export const meta: Route.MetaFunction = () => {
  return [
    { title: "Post a Job | Alice" },
      ...
      <Form className="max-w-screen-2xl flex flex-col items-center gap-10 mx-auto">
        <div className="grid grid-cols-3 w-full gap-10">
          ...
          <InputPair
            ...
            type="text"
            required
            placeholder="i.e Implement new features, fix bugs, etc."
            textArea
          />
          <InputPair
            id="qualifications"
          ...
          <InputPair
            ...
            type="url"
            required
            placeholder="i.e https://www.alice.services/jobs/apply"
          />
          <SelectPair
            label="Job Type"
          ...
          <SelectPair
            ...
            options={JOB_SALARIES.map((salary) => ({
              label: salary,
              value: salary,
            }))}
          />
